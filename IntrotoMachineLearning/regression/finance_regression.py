...
import sys
import pickle
sys.path.append("G:/Udacity_ML/ud120-projects-/tools/")
from feature_format import featureFormat, targetFeatureSplit
dictionary = pickle.load( open("G:/Udacity_ML/ud120-projects-/final_project/final_project_dataset_modified.pkl", "rb") )
